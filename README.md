...
- 관리자 화면은 부스 운영 상태, NFC, 방문 기록, 수동 승인 중심의 P0 데모로 구성

## 중요한 제한

현재 Google 로그인, 관리자 권한, NFC 적립과 스탬프는 실제 서버 기능이 아닙니다. 브라우저 `localStorage`에 저장되는 UI 테스트 데이터입니다. 리뷰·보상·교환 기능은 P0 화면에서 노출하지 않습니다.
